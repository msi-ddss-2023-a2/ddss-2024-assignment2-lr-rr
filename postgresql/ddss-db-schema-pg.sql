...
insert into books (title, authors, category, price, book_date, keywords, notes, recomendation,
                   description)
       values('Web Database Development : Step by Step', 'Jim Buyens', 'Databases',  39.99, '2007-01-01 12:00:00', 'Web; persistence; sql', 'This is a very nice book.', 4,
...
insert into books (title, authors, category, price, book_date, keywords, notes, recomendation,
                   description)
       values('Programming Perl (3rd Edition)', 'Larry Wall, Tom Christiansen, Jon Orwant', 'Programming',  39.96, '2009-12-01 12:00:00', 'Perrl; scripts; code', 'This is a very nice book.', 3, 
...
insert into books (title, authors, category, price, book_date, keywords, notes, recomendation,
                   description)
       values('Perl and CGI for the World Wide Web: Visual QuickStart Guide', 'Elizabeth Castro', 'Programming',  15.19, '2009-06-01 12:00:00', 'Perral; scripts; code', 'This is a very nice book.', 5, 
